namespace TSAK.PetShopComp._2021.UI
{
    public class StringConstants
    {
        ...
        public const string CreatePetGreeting =
            "Welcome to the pet factory, please follow the instructions to create your new pet";
        ...
        public static string PetPrice = "Please enter the price of the pet";
    }
}